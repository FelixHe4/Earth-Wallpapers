...
public class EarthWallpapers {
	...
	public static void start(String site) throws IOException, BadLocationException {
		...
		for (; iterator.isValid(); iterator.next()) {
			...
			if (imgSrc != null) {
				...
				} else if (lower.contains("redd.it/") && ((lower.contains(".jpg") || (lower.contains(".png")) || (lower.contains(".jpeg"))
	...
	public static void downloadImage(String site, String imageS) throws IOException {
		...
		try {
			...
			imgPath = home + File.separator + "Desktop" + File.separator + "RedditPics";
